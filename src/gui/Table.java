...
public class Table {
    ...
    public void drawCompleteTable(GamePanel gamePanel, GameInstance gameInstance, Graphics g){
        ...
        int diameter = (int) (this.diameter * gamePanel.getBoardToScreenTransform().getScaleX());
        int playerDiameter = (int) (this.playerDiameter * gamePanel.getBoardToScreenTransform().getScaleX());
