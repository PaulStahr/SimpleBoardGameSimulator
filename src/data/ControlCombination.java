...
public class ControlCombination
{
	...
	public StringBuilder toString(StringBuilder strB, Language lang) {
		...
		if ((keyModifier & InputEvent.CTRL_DOWN_MASK) != 0)		{appendPlus(strB).append(lang.getString(Words.ctrl));}
		if ((keyModifier & InputEvent.ALT_DOWN_MASK) != 0)		{appendPlus(strB).append(lang.getString(Words.alt));}

		if (keyCode != -1){appendPlus(strB).append(KeyEvent.getKeyText(keyCode));}
		...
		if ((additional & 1) != 0)	{appendPlus(strB).append(lang.getString(Words.drag));}
		if ((additional & 2) != 0)	{appendPlus(strB).append(lang.getString(Words.grab));}
		if ((additional & 4) != 0)	{appendPlus(strB).append(lang.getString(Words.rotate_wheel));}
		if ((additional & 8) != 0)  {appendPlus(strB).append(lang.getString(Words.drop_on_board));}
		if ((additional & 16) != 0) {appendPlus(strB).append(lang.getString(Words.arrow_keys));}
		if ((additional & 32) != 0) {appendPlus(strB).append(lang.getString(Words.double_click));}
