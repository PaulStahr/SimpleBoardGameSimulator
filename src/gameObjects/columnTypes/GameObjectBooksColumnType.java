...
public enum GameObjectBooksColumnType implements TableColumnType {
    ...
    private static final GameObjectBooksColumnType ct[] = GameObjectBooksColumnType.values();
    private static final String[] columnNames = TableColumnType.getColumnNames(ct);

    public static final int size(){return ct.length;}

    public static final GameObjectBooksColumnType get(int index){return ct[index];}
    ...
    private GameObjectBooksColumnType(String name, byte optionType, Object defaultValue, String possibleValues[]) {
        this.name = name;
    ...
    public static GameObjectBooksColumnType getByName(String name) {
