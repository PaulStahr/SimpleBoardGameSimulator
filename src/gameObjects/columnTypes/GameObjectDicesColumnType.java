...
public enum GameObjectDicesColumnType implements TableColumnType {
    ...
    private static final GameObjectDicesColumnType ct[] = GameObjectDicesColumnType.values();
    private static final String[] columnNames = TableColumnType.getColumnNames(ct);

    public static final int size(){return ct.length;}

    public static final GameObjectDicesColumnType get(int index){return ct[index];}
    ...
    private GameObjectDicesColumnType(String name, byte optionType, Object defaultValue, String possibleValues[]) {
        this.name = name;
