...
public enum GameObjectFiguresColumnType implements TableColumnType {
    ...
    private static final GameObjectFiguresColumnType ct[] = GameObjectFiguresColumnType.values();
    private static final String[] columnNames = TableColumnType.getColumnNames(ct);

    public static final int size(){return ct.length;}

    public static final GameObjectFiguresColumnType get(int index){return ct[index];}
    ...
    private GameObjectFiguresColumnType(String name, byte optionType, Object defaultValue, String possibleValues[]) {
        this.name = name;
    ...
    public static GameObjectFiguresColumnType getByName(String name) {
