...
public class DrawFunctions {
    ...
    public static void drawBoard(GamePanel gamePanel, Graphics g, GameInstance gameInstance){
        ...
        ((Graphics2D)g).translate(gamePanel.getWidth() / 2, gamePanel.getHeight() / 2);
        ((Graphics2D)g).scale(gamePanel.zooming, gamePanel.zooming);
        ((Graphics2D)g).rotate(gamePanel.rotation);
        ((Graphics2D)g).translate(gamePanel.translateX, gamePanel.translateY);
        gamePanel.privateArea.setArea(gamePanel.getWidth()/4, gamePanel.getHeight()-250, gamePanel.getWidth()/2, 500, gamePanel.translateX, gamePanel.translateY, gamePanel.rotation, gamePanel.zooming);
