...
public class PrivateAreaTest {
    ...
    public void removeObjectFromPrivateArea() throws IOException, JDOMException
    {
        ...
        PrivateArea pa = new PrivateArea(gi, pl, new AffineTransform(), new AffineTransform());
        ...
        ObjectFunctions.insertIntoOwnStack(id, gi, pl, new Point2D.Double(), 0, oi, null, 0, 0);
        assertEquals(1, pa.objects.size());
        ObjectFunctions.removeFromOwnStack(id, gi, pl, oi);
        assertEquals(0, pa.objects.size());
    }
}
